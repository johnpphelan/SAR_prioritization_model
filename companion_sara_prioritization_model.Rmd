...
rel_streams = bcdc_query_geodata("freshwater-atlas-stream-network") |> 
  filter(fwa_pattern) |> 
  collect() |> 
  dplyr::summarise() |> 
...
### Strength of Potential Negative Effect of AIS on SAR
...
predation - competition - habitat modification - nutrient depletion -
disease/parasite transmission The uncertainty of the strength of these
effects was also assessed.
...
ggplot() + 
  geom_sf(data = bc, col = 'lightgrey', fill = 'transparent') + 
